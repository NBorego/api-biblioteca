...
namespace APIBiblioteca.Services.Interfaces
{
    ...
    {
        Task<object> GetAllAsync(int pageNumber, int pageQuantity, string bookName);
        Task<object> GetAllByReaderIdAsync(Guid id, int pageNumber, int pageQuantity, string bookName);
